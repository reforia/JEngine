...
namespace JEngine
{
	// Wrap up some custom types for multi-platform support
	enum class ShaderDataType : uint8_t
	{
		None = 0, Float, Float2, Float3, Float4, Mat3, Mat4, Int, Int2, Int3, Int4, Bool
	};

	// Get the byte of each data
	...
	// Defines how a buffer element should look like, 
	// A buffer could contain multiple Buffer elements
	...
	// The class of buffer layout, which contains multiple BufferElements
	class BufferLayout
	{
	public:
		BufferLayout() {}
